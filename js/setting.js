...
{ // Meal Package Dropdwon Section
    // let listOff1 = document.getElementById('myDropdown1');
    // let dropbtn1 = document.getElementById('dropbtn1')
...
{ // Meal Subscription Section
    let mealSuhCheckeBoxL = document.querySelector('.mealSubL');
    let mealSuhCheckeBoxD = document.querySelector('.mealSubD');
    let errTxt = document.querySelector('.errTxt');


    mealSuhCheckeBoxL.addEventListener('click', () => {
        if (mealSuhCheckeBoxL.checked !== true && mealSuhCheckeBoxD.checked !== true) {
            errTxt.innerHTML = "Please Select At Least One Package!"
        } else {
            errTxt.innerHTML = ""
        }
    })
    mealSuhCheckeBoxD.addEventListener('click', () => {
        if (mealSuhCheckeBoxL.checked !== true && mealSuhCheckeBoxD.checked !== true) {
            errTxt.innerHTML = "Please Select At Least One Package!"
        } else {
            errTxt.innerHTML = ""
